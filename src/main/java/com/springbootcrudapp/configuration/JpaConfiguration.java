package com.springbootcrudapp.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.springbootcrudapp.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.springbootcrudapp.model" });
